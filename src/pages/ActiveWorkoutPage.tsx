...
import { WorkoutTemplate, CompletedExercise, ExerciseDefinition, ExerciseSet } from '../types';
        ...
        const initializeWorkout = async () => {
            ...
            try {
                ...
                if (templateId) {
                    ...
                    name = template.name;
                    initialExercises = template.exercises.map(def => ({
                        id: '', // Will be generated by backend
                        exerciseDefinitionId: def.id,
                        exerciseName: def.name,
                        sets: [],
                    }));
                } else if (location.state && (location.state as LocationState).template) {
                    // This path might be less common if templateId is preferred
                    const template = (location.state as LocationState).template;
                    name = template.name;
                    initialExercises = template.exercises.map(def => ({
                        id: '', // Will be generated by backend
                        exerciseDefinitionId: def.id,
